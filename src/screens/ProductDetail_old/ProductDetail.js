    ...
    render() {
        ...
        return (
            <ParallaxScrollView
                ...
                renderStickyHeader={() => (
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 5, paddingVertical: 10, backgroundColor: "#ce0b24" }}>
                        <Text style={{ fontSize: 14, fontWeight: 'bold', color: 'white', flexWrap: 'wrap', flex: 1 }}>Product Detail Example 1</Text>
                ...
                renderForeground={() => (
                    <View style={styles.listItem}>
                        <Image resizeMode="cover" source={{ uri: 'https://images.pexels.com/photos/270286/pexels-photo-270286.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940' }} style={styles.placeImage} />
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 5, paddingVertical: 10, backgroundColor: "#ce0b24" }}>
                            <Text style={{ fontSize: 14, fontWeight: 'bold', color: 'white', flexWrap: 'wrap', flex: 1 }}>Product Detail Example _1</Text>
                            {/* <Text style={{ fontSize: 14, color: 'white', flexWrap: 'wrap', flex: 1 }}>{this.props.tourcontent.name}</Text> */}
                        </View>
                    </View>
                )}>
                ...
                <View style={styles.content}>
                    ...
                    <Text style={{ fontWeight: 'bold', paddingTop: 10 }}>Quantity: </Text>
